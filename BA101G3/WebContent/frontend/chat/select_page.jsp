...
<ul>
    ...
    <li><a href='<%=request.getContextPath()%>/frontend/chat/ChatFriend/listMemCFCGSBYMemNo.jsp?'>List</a>listMemCFCGSBYMemNo</li>
    
    <br><br>

    <li>
        <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/chat/ChatFriend/ChatServlet.do">
            <p>好友列表綜合</p>
            <p>輸入會員編號 (如 M0000001 ):</p>
            <input type="text" name="mem_no">
            <input type="submit" value="送出">getOneMemCFCG ChatServlet
