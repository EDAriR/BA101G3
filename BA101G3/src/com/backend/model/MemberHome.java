...
public class MemberHome {
	...
	public Member findById(java.lang.String id) {
		...
		try {
			Member instance = (Member) sessionFactory.getCurrentSession().get("com.backend.model.Member", id);
			if (instance == null) {
	...
	public List<Member> findByExample(Member instance) {
		...
		try {
			List<Member> results = (List<Member>) sessionFactory.getCurrentSession()
					.createCriteria("com.backend.model.Member").add(create(instance)).list();
