 ...
 * @see com.backend.model.Question
...
public class QuestionHome {
	...
	public Question merge(Question detachedInstance) {
		...
		try {
			Question result = (Question) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Question findById(java.lang.String id) {
		...
		try {
			Question instance = (Question) sessionFactory.getCurrentSession().get("com.backend.model.Question", id);
			if (instance == null) {
	...
	public List<Question> findByExample(Question instance) {
		...
		try {
			List<Question> results = (List<Question>) sessionFactory.getCurrentSession()
					.createCriteria("com.backend.model.Question").add(create(instance)).list();
