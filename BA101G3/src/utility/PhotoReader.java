...
public class PhotoReader extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            String pho_no2 = new String(pho_no.getBytes("ISO-8859-1"), "Big5");
            ResultSet rs = stmt.executeQuery("select PHO_FILE from PHOTO where PHO_NO = '"
                    + pho_no2 + "'");

            if (rs.next()) {
//				byte[] bytes = rs.getBytes("pho_file");
                BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("pho_file"));
