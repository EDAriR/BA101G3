...
public class PhotoUpload extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        System.out.println("xxxxx============" + req.getParameter("baby_no")); 
...
//              String filename =  new String(getFileNameFromPart(part).getBytes("ISO-8859-1"),"UTF-8");
             ...
             // 額外測試 InputStream 與 byte[] (幫將來model的VO預作準備)
                ...
                if (action.equals("p")) {
                    ...
                    photosvc.addPhoto(baby_no, filename, filename, buf, "0");
                    System.out.println("insert photo OKxxxxxxxxxxxxxxxxxxxxxXX!!!");
                }
