	...
	<section>
		<div class="container">
			<div class="col-xs-12 col-sm-10 col-sm-offset-1 centerTable">
				...
				<h3 style='padding-left: 0px;'>資料修改:</h3>
				<%-- 錯誤表列 --%>
				...
				<FORM NAME="updateConfirm" METHOD="post" ACTION="<%=request.getContextPath()%>/diary/growing_diary.do" name="form1" enctype="multipart/form-data">
			...
			<div class="col-xs-12 col-sm-10 col-sm-offset-1 updateConfirmPadding">
				<div class="btn-group btnDiaryControl">
					<a href="javascript:document.updateConfirm.submit()" class="btn btn-default updateConfirm" role="button">送出修改</a>
				</div>
			</div>
		</div>
	</section>
